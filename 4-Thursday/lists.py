...
# 3. Create a while loop that iterates through each of the items in the planet list and changes them to lowercase.

# index = 0

# while index < len(planets):
#     print(f"{planets[index].lower()}")
#     index+=1
...
# print(HoustonCities + ClearLakeCities)

HoustonCities.extend(ClearLakeCities)

Houston = HoustonCities

# Houston.append("Salt Lake City")
...
# 11. Copy the Houston list to a list called USCities - using .copy()
